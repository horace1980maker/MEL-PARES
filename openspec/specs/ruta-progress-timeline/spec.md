...
Ruta del Proyecto provides a standalone, editable timeline based on the TIMELINE sheet from `MEL PROPOSAL V6.xlsx`.
...
- **WHEN** an authenticated admin changes No. Entregable, Output, Orden, Ano, Mes, Entregable, or Estado
