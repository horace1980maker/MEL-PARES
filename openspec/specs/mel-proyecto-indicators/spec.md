## Purpose
Define the MEL Proyecto dashboard capability for project-level MEL indicators, including seeded indicator data, admin-only editing, visual progress bars, summary metrics, filtering, and XLSX export.
